...
vec2 color_func(vec2 a){
	...
	return (1.0-t)*(complex_multiply(a, complex_multiply(a, a)) - vec2(1, 1)) + t*complex_divide(complex_multiply(a, a) - vec2(1, 0),complex_multiply(a, complex_multiply(a, a)) + vec2(2, 2));
}
